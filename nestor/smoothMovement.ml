...
let send_consigne rm =
  ...
  rm.last_time <- t2;
  Interface_local.roomba_cmd rm.roomba (Type_def.DriveDirect (rm.last_left,rm.last_right));
...
let stop_consigne rm = 
  Interface_local.roomba_cmd rm.roomba (Type_def.Drive (0,0));
